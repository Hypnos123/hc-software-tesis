...
export class InterfazChatComponent implements OnDestroy {
  ...
  quickQuestions = ['¿Qué preguntas puedo hacer?','Buscar paciente por DNI','Buscar paciente por nombre','Verificar historia clínica','Consultas médicas de un paciente','Buscar posibles duplicados','Últimos pacientes registrados','Total de pacientes','Estadísticas por edad'];
